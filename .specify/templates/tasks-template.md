...
**Tests**: Test tasks are MANDATORY. Every user story must include test work proportional to risk.
...
- [ ] T004 [P] Configure static analysis and quality gates in CI
...
- [ ] T011 Define UX consistency checklist and shared interaction patterns
- [ ] T012 Define performance baseline, targets, and measurement script
...
- [ ] T013 [P] [US1] Unit tests for business rules in tests/unit/test_[name].py
...
- [ ] T022 [US1] Validate UX consistency criteria for this story
- [ ] T023 [US1] Run performance check for this story against target budget
...
- [ ] T024 [P] [US2] Unit tests for business rules in tests/unit/test_[name].py
...
- [ ] T031 [US2] Validate UX consistency criteria for this story
- [ ] T032 [US2] Run performance check for this story against target budget
...
- [ ] T033 [P] [US3] Unit tests for business rules in tests/unit/test_[name].py
...
- [ ] T039 [US3] Validate UX consistency criteria for this story
- [ ] T040 [US3] Run performance check for this story against target budget
...
- Include UX consistency and performance evidence before marking story complete
